...
if [ ! -z "$BACKUP_LOG_FOLDER" ] && [ ! -z "$BACKUP_LOGGING_STATIC_FILES_ROTATION_LOG_FILENAME" ]; then
    CURRENT_TIME=$(date "+%Y_%m_%d-%H_%M_%S")
    LOG_MESSAGE_FILE="$BACKUP_LOG_FOLDER/$BACKUP_LOGGING_STATIC_FILES_ROTATION_LOG_FILENAME""_$CURRENT_TIME.log"
fi
